@extends('panel.layouts.master' , ['title' => __('panel.articles') , 'active'=>'lectures' , 'sub_active'=>'add'])
@section('content')
                            ...
                            <div class="card-body">
                                ...
                                @foreach(locales() as $key => $lang)
                                    ...
                                    <div class="form-group">
                                     ...
                                     <div class="form-group">
                                        <label>{{ __('panel.youtube') }}({{ $lang['name'] }})
                                            <span class="text-danger">*</span></label>
                                        <textarea class="form-control" name="video_link" rows="5"
                                                  required>{{isset($item)?@$item->translate($key)->video_link:''}}</textarea>
                                    </div>
                                @endforeach
