@extends('panel.layouts.master' , ['title' => __('panel.faq') , 'active'=>'fags' , 'sub_active'=>'add'])
@section('content')
                        ...
                        <div class="card card-custom gutter-b ">
                            ...
                            <div class="card-body">
                                ...
                                @foreach(locales() as $key => $lang)
                                    ...
                                    <div class="form-group">
                                        <label>{{ __('constants.answer') }}({{ $lang['name'] }})
                                            <span class="text-danger">*</span></label>
                                        <textarea class="form-control" name="answer_{{$key}}" rows="5"
                                                  required>{{isset($item)?@$item->translate($key)->answer:''}}</textarea>
                                    </div>
