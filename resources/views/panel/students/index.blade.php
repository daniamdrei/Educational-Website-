@extends('panel.layouts.master' , ['title' => __('panel.students')])
@section('content')
                    ...
                    <div class="mb-7">
                        <div class="row align-items-center d-flex justify-content-between">
                            ...
                            <div class="col-lg-4 col-xl-4 d-flex justify-content-end">
                                <a href="{{ route('panel.students.create') }}"
...
@push('panel_js')
    ...
    <script>
        window.data_url = '{{route('panel.students.datatable')}}';
        window.columns = [
            {
                field: ' ',
                title: "#",
