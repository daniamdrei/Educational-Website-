 <header id="header" class="main-header header-fixed fixed-header">
                            ...
                            <div class="inner-header">
                                <div class="inner-header-left">
                                    <div class="logo-box flex">
                                        <div class="logo"><a href="index.html"><h4 class="text-primary">EduCore </h4> </a></div>
                                    </div>
                                                ...
                                                <div class="navbar-collapse collapse clearfix" id="navbarSupportedContent">
                                                    <ul class="navigation clearfix">
                                                        ...
                                                        <li class="dropdown2"><a href="#">Courses</a>
                                                            <ul>
                                                                <li><a href="property-halfmap-grid.html">Courses1</a></li>
                                                                <li><a href="property-halfmap-list.html">Courses2</a></li>
                                                                <li><a href="topmap-grid.html">Courses3</a></li>
                                                                <li><a href="topmap-list.html">Courses4</a></li>
                                                                <li><a href="sidebar-grid.html">Courses5</a></li>
                                                                <li><a href="sidebar-list.html">Courses5</a></li>
                                                            </ul>
                                                        </li>
                                                        ...
                                                        <li class="dropdown2"><a href="#">Blog</a>
                                                            <ul>
                                                                ...
                                                                <li><a href="blog-grid.html">Blog 2</a></li>
                                                                <li><a href="blog-detail.html">Blog 3</a></li>
                                                            </ul>
                                                        </li>
                                                        ...
                                                        <li class="dropdown2"><a href="#">Dashboard</a>
                                                            <ul>
                                                                ...
                                                                <li><a href="my-property.html">My Courses</a></li>
                ...
                <div class="mobile-menu">
                    ...
                    <nav class="menu-box">
                        <div class="nav-logo"><a href="index.html"><img src="appAssets/images/logo/logo@2x.png" alt="nav-logo" width="174" height="44"></a></div>
