...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'options.*.name_ar' => 'اسم الخيار (بالعربية)',
        'options.*.name_en' => 'اسم الخيار (بالإنجليزية)',
        'options.*.options.*.name_ar' => 'اسم الخيار الفرعي (بالعربية)',
        'options.*.options.*.name_en' => 'اسم الخيار الفرعي (بالإنجليزية)',
        'options.*.type' => 'نوع الخيار',
        'options.*.options' => 'الخيارات الفرعية',
        'options.*.options.*.available_quantity' => 'الكمية المتوفرة',
        'options.*.options.*.quantity_for_sale' => 'الكمية المتاحة للبيع',
        'options.*.options.*.additional_cost' => 'التكلفة الإضافية',
